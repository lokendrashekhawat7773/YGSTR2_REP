...
define view entity YJV_GSTR2 as select from YGSTR2_JV_DOCUMENT 
...
union
 ...
 select from YGSTR2_JV_DOCUMENT 
...
//      @Semantics.amount.currencyCode: 'TransactionCurrency'
  ...
  //    IsNegativePosting,
      ...
      AccountingDocCreatedByUser,
      PersonFullName
} where ( AccountingDocumentType =  'SA' or AccountingDocumentType =  'JV' ) 
